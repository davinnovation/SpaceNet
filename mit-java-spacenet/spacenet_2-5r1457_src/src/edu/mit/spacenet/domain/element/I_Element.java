...
public interface I_Element extends I_DomainObject, Comparable<I_Element> {
	 ...
	 * 
	 * @return the total mass of the element and any nested elements
	 * (kilograms)
	 */
	public double getTotalMass();
	
	/**
	 * Get the total mass of all contained resources of the specified class of
	 * supply.
	 * 
	...
	/**
	 * Gets whether this element is nested at some level inside a given
	 * container.
	 * 
	...
	/**
	 * Generates the set of aggregate demands from the element's active state
	 * for the specified duration (in days).
	 * 
	...
	/**
	 * Request the element to satisfy the given demands (may be passed to nested
	 * elements).
	 * 
	...
	/**
	 * Gets the amount of additional COS5 required to secure this element when
	...
	/**
	 * Sets the amount of additional COS5 required to secure this element when
	 * being placed inside a carrier.
	 * 
	...
	/**
	 * Gets the icon representation of the element. Returns a default icon
	 * based on element type if  no icon is previously set.
	 * 
