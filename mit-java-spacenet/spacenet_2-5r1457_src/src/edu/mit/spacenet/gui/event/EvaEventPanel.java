...
/**
 * A panel for viewing and editing a EVA event.
 * 
 * @author Paul Grogan
 */
public class EvaEventPanel extends AbstractEventPanel {
	private static final long serialVersionUID = 769918023169742283L;
	
	private EvaEvent event;
	
	private SpinnerNumberModel evaDurationModel;
	private JSpinner evaDurationSpinner;
	...
	/**
	 * Instantiates a new eva event panel.
	 * 
	 * @param eventDialog the event dialog
	 * @param event the event
	 */
	public EvaEventPanel(EventDialog eventDialog, EvaEvent event) {
