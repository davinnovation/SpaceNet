...
public class ElementDialog extends JDialog {
	...
	private void buildDialog() {
		...
		c.gridx+=2;
		accommodationMassModel = new SpinnerNumberModel(0,0,Double.MAX_VALUE,GlobalParameters.getMassPrecision());
		...
		accommodationMassSpinner.setToolTipText("Additional mass of COS 5 required to nest inside a carrier [kilograms]");
		...
		c.gridx+=2;
		c.weightx = 1;
		volumeModel = new SpinnerNumberModel(0,0,Double.MAX_VALUE,GlobalParameters.getVolumePrecision());
		...
		okButton = new JButton("OK", new ImageIcon(getClass().getClassLoader().getResource("icons/brick_go.png")));
		...
		JButton cancelButton = new JButton("Cancel", new ImageIcon(getClass().getClassLoader().getResource("icons/brick_delete.png")));
	...
	private JPanel buildStatesPanel() {
		...
		JButton addStateButton = new JButton("Add", new ImageIcon(getClass().getClassLoader().getResource("icons/clock_add.png")));
		...
		editStateButton = new JButton("Edit", new ImageIcon(getClass().getClassLoader().getResource("icons/clock_edit.png")));
		...
		setInitialStateButton = new JButton("Set Initial", new ImageIcon(getClass().getClassLoader().getResource("icons/clock.png")));
		...
		removeStateButton = new JButton("Remove", new ImageIcon(getClass().getClassLoader().getResource("icons/clock_delete.png")));
	...
	private JPanel buildPartsPanel() {
		...
		JButton addPartButton = new JButton("Add", new ImageIcon(getClass().getClassLoader().getResource("icons/wrench_add.png")));
		...
		editPartButton = new JButton("Edit", new ImageIcon(getClass().getClassLoader().getResource("icons/wrench_edit.png")));
		...
		removePartButton = new JButton("Remove", new ImageIcon(getClass().getClassLoader().getResource("icons/wrench_delete.png")));
	...
	public boolean isElementValid() {
		...
		for(AbstractElementPanel panel : elementPanels) {
			if(!panel.isElementValid()) return false;
		}
		return true;
	}
	...
	private void saveElement() {
		if(isElementValid()) {
			...
			if(eventDialog!=null) {
				...
				} else element.setIconType((ElementIcon)iconCombo.getSelectedItem());
			}
			...
			if(dataSourceDialog!=null) {
				try {
					...
					e.printStackTrace();
					JOptionPane.showMessageDialog(dataSourceDialog, 
							"SpaceNet Errror",
