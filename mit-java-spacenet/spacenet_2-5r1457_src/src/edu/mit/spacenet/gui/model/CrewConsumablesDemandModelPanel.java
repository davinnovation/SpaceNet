...
/**
 * The panel for viewing and editing crew consumables mission-level demand 
 * models.
 * 
...
public class CrewConsumablesDemandModelPanel extends AbstractDemandModelPanel {
	...
	private SpinnerNumberModel crewSizeModel, crewTimeModel, 
		explorationDurationModel, transitDurationModel, reservesDurationModel, 
		waterRecoveryModel, clothingLifetimeModel;
	private JSpinner crewSizeSpinner, crewTimeSpinner,
		explorationDurationSpinner, transitDurationSpinner, reservesDurationSpinner,
		waterRecoverySpinner, clothingLifetimeSpinner;
	private JCheckBox transitDemandsCheck;
	private SpinnerNumberModel waterRateModel, evaWaterRateModel, foodSupportRateModel, 
		ambientFoodRateModel, rfFoodRateModel, oxygenRateModel, evaOxygenRateModel, 
		nitrogenRateModel, hygieneRateModel, hygieneKitModel, clothingRateModel, 
		personalItemsModel, officeEquipmentModel, evaSuitModel, evaLithiumHydroxideModel, 
		healthEquipmentModel, healthConsumablesModel, safetyEquipmentModel, 
		commEquipmentModel, computerEquipmentModel, trashBagRateModel, wasteContainmentRateModel;
	private JSpinner waterRateSpinner, evaWaterRateSpinner, foodSupportRateSpinner, 
		...
		commEquipmentSpinner, computerEquipmentSpinner, trashBagRateSpinner, wasteContainmentRateSpinner;
	...
	private JPanel buildInputsPanel() {
		...
		c.gridy++;
		explorationDurationModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getTimePrecision());
		...
		c.gridy++;
		transitDurationModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getTimePrecision());
		...
		c.gridy++;
		reservesDurationModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getTimePrecision());
		...
		c.gridy++;
		waterRecoveryModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getTimePrecision());
		...
		c.gridy++;
		clothingLifetimeModel = new SpinnerNumberModel(1, 1, Double.MAX_VALUE, GlobalParameters.getTimePrecision());
	...
	private JPanel buildRatesPanel() {
		...
		c.gridx = 1;
		c.anchor = GridBagConstraints.LINE_START;
		waterRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		evaWaterRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		foodSupportRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		ambientFoodRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		rfFoodRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		oxygenRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		evaOxygenRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		nitrogenRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		hygieneRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		hygieneKitModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		clothingRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy = 0;
		c.gridx+=2;
		personalItemsModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		officeEquipmentModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		evaSuitModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		evaLithiumHydroxideModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		healthEquipmentModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		healthConsumablesModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		safetyEquipmentModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		commEquipmentModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		computerEquipmentModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		trashBagRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
		...
		c.gridy++;
		wasteContainmentRateModel = new SpinnerNumberModel(0, 0, Double.MAX_VALUE, GlobalParameters.getDemandPrecision());
	...
	private JPanel buildDemandsPanel() {
		...
		c.weighty = 1;
		c.weightx = 1;
		demandTable = new DemandTable(SpaceNetFrame.getInstance().getScenarioPanel().getScenario().getDataSource().getResourceLibrary());
