...
public class FlightEdgeEditorPanel extends AbstractEdgeEditorPanel {
	...
	public void buildPanel(){
		...
		durationSpinner.setToolTipText("Total duration of the abstracted flight between origin and destination [days]");
		...
		c.anchor = GridBagConstraints.LINE_START;
		c.fill = GridBagConstraints.NONE;
		maxCargoModel = new SpinnerNumberModel(0,0,Double.MAX_VALUE, GlobalParameters.getMassPrecision());
