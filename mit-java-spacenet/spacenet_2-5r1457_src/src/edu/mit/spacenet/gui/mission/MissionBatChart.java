		...
		for(I_Event event : getMission().getEventList()) {
			if(event.getLocation() instanceof Node) {
				 if(event instanceof SpaceTransport 
					...
					s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime())), 
							node2Number(((SpaceTransport) event).getEdge().getOrigin(), rangeAxis));
					s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime() + ((SpaceTransport)event).getEdge().getDuration())), 
					...
					if(((SurfaceTransport)event).isReversed()) {
						...
						s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime() + ((SurfaceTransport)event).getDuration())), 
					...
					s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime() + ((FlightTransport)event).getEdge().getDuration())), 
					...
					s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime() + ((ExplorationProcess)event).getDuration())), 
							node2Number((Node)event.getLocation(), rangeAxis));
					((TimeSeriesCollection)dataset).addSeries(s);
					...
					if(event instanceof CreateEvent) {
						...
						s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime())), 
								node2Number((Node)event.getLocation(), rangeAxis));
						s.addOrUpdate(new Hour(DateFunctions.getDate(getScenario().getStartDate(), DateFunctions.getDaysBetween(getScenario().getStartDate(), getMission().getStartDate()) + event.getTime() + ((EvaEvent)event).getEvaDuration()/24)), 
								node2Number((Node)event.getLocation(), rangeAxis));
						((TimeSeriesCollection)dataset).addSeries(s);
						r.setSeriesPaint(dataset.getSeriesCount() - 1, Color.CYAN);
						r.setSeriesShape(dataset.getSeriesCount() - 1, 
